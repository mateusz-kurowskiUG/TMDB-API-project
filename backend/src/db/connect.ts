...
import {
  ...
  type isReviewValidInterface,
  type GetReviewsResponse,
  type DeleteReviewResponse,
  type MovieUpdateResponse,
  type GetGenresReponse,
  type GetUserResponse,
  type UpdateUserProfileResponse,
  type MovieDeletionResponse,
} from "../types/DBResponse";
...
import type PlaylistInterface from "../types/Playlist";
import type { ReviewInterface } from "../types/ReviewInterface";
import type { MovieUpdateInterface } from "../types/MovieUpdate";
import type GenreInterface from "../types/Genre";
import genreSchema from "./models/Genre";
import type { CastInterface } from "../types/CastInterface";
...
class Db {
  ...
  async testData() {
    ...
    const m1 = db2.createMovie(movie1, [testGenre.properties().id]);
    const m2 = db2.createMovie(movie2, [testGenre2.properties().id]);

    const m3 = db2.createMovie(
      {
  ...
  async getReviewsByUser(user: Node<User>): Promise<ReviewInterface[]> {
